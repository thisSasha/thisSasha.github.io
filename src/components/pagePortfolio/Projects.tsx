...
const maxProjects = isMobile ? 2 : 6;
            ...
            <div className="container pb-10">
                ...
                {hasMore ? (
                    ...
                    >
                        ...
                        <button className="md:py-1 py-3 rounded-xl md:rounded-md cursor-pointer border border-fg-500 px-8 md:px-4 bg-bg-100 text-fg-50">
