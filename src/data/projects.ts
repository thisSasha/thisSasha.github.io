...
export const projects: ProjectsType = [
  ...
  {
    img: "/projects/cactus_bot/preview.png",
    title: "Cactus Бот",
    description: "Действующий Телеграм-бот, для крупного чата такси",
    type: "Заказ (Бот)",
    using: ["devicon-python-plain"],
    filters: ["Python", "Telegram", "Aiogram", "OpenAI"],
    links: {
      "Чат с ботом": "https://t.me/igormylnikovchannelchat/282780",
    },
  },
  {
    ...
    description:
      "ТЗ: Дан Wordpress шаблон и старый сайт. Задача в стиле шаблона перенести весь контент с сайта",
  ...
  },
  {
    ...
    title: "Т-Анон",
    description:
      "Телеграм-бот для отправки анонимных сообщений с раличными фичами. В данный момент бот неактивен, так как нет сервера",
    type: "Пет-проект",
  ...
  },
  {
    ...
    description:
      "Быстрый файловый менеджер для использования в консоли. На данный момент не закончен",
    type: "Пет-проект",
    filters: ["Rust"],
  ...
  },
  {
    ...
    links: {
      Копия: "https://energypark-copy.onrender.com/",
      Оригинал: "https://energy-park.co.uk",
    },
  },
  {
    ...
    description:
      "Создание простого телеграм-бота. Функции: Админы могут создавать посты в различных тгк с кнопкой 'Откликнуться', а пользователи могут отправлять свои заявки",
    type: "Заказ (Тг-бот)",
    using: ["devicon-python-plain"],
    filters: ["Python", "Telegram", "Aiogram"],
  ...
  },
  {
    ...
    title: "FX For Trader",
    description:
      "'Повтори вот этот сайт по вот этому макету но сделай по-своему' - Примерно такое было ТЗ",
  ...
  },
  {
    ...
    description:
      "Полная копия страницы расширения и стартовой страницы (По требованию заказчика, пришлось переделать расширение в статичны сайт)",
    type: "Заказ (Копия сайта)",
    using: ["devicon-javascript-plain"],
  ...
  },
  {
    ...
    filters: ["Vanilla JS", "JavaScript", ""],
    links: {
      Github: "https://github.com/thisSasha/trihologs_copy",
      "Оригинальный сайт": "https://trihologs.lv/",
    },
  },
  {
    ...
    title: "Patriot",
    description:
      "Вёрстка сайта по макету. Макет был основой, но кроме него присуствовал прототип, которому также нужно было следовать. Поэтому сайт отличается от макета",
    type: "Заказ (Новый сайт)",
    using: ["devicon-javascript-plain", "devicon-tailwindcss-plain"],
    ...
    links: {
      ...
      "Макет (Figma)":
        "https://www.figma.com/design/TddgqKLSGWQAAaiH5uBsOW/%D0%9C%D0%B5%D1%82%D0%B0%D0%BB--1-?node-id=9333-20464&p=f&t=slOtg4O4DTHeQ7hL-0",
    },
  },
  {
    ...
    title: "Spam AI",
    description:
      "Телеграм-бот, основанный на библиботеке g4f. Определяет тему сообщения(Обычное, политика, флуд и др.) и выполняет заданную админом команду",
    type: "Пет-проект",
    using: ["devicon-python-plain", "fab fa-telegram"],
    filters: ["Python", "Telegram", "Aiogram"],
    links: {},
  },
  {
    ...
    title: "Meta Parser",
    description:
      "Фронтенд и бэкенд сайта, который получает meta с указанного сайта, рисует дерево субстраниц и выводит всё красивыми картинками",
    type: "Заказ (Новый сайт)",
    using: ["devicon-python-plain", "devicon-javascript-plain"],
    filters: ["Python", "Javascript", "Vanilla JS", "Vanilla CSS", "FastAPI"],
    links: { Github: "https://github.com/thisSasha/check-meta" },
  },
  {
    img: "/projects/math/preview.png",
    title: "Math",
    description: "Телеграм-канал на тему математики",
    type: "Telegram-канал",
  ...
  },
  {
    ...
    title: "Menu Nova",
    description:
      "Проект для кафе и ресторанов. Онлайн меню и заказ, быстрая настройка под конкретный ресторан (Планирую переписать на Vue/React)",
    type: "Пет-проект",
    using: ["devicon-python-plain", "devicon-javascript-plain"],
    filters: ["Python", "Javascript", "Vanilla JS", "Vanilla CSS"],
    links: {
      Github: "https://github.com/menuNova",
      "Главная страница": "https://menuNova.github.io/index",
    },
  },
  {
  ...
  },
  {
    ...
    title: "Sparkline",
    description: "Вёрстка по png макету",
    type: "Заказ (Новый сайт)",
    using: ["devicon-tailwindcss-plain", "devicon-javascript-plain"],
    filters: ["Javascript", "Vanilla JS", "Tailwind CSS"],
    links: {
  ...
  {
    img: "/projects/rubenhair_copy/preview.png",
